...
[![godoc for RichardKnop/machinery](https://godoc.org/github.com/nathany/looper?status.svg)](http://godoc.org/github.com/minight/machinery/v1)
...
[![Go Report Card](https://goreportcard.com/badge/github.com/minight/machinery)](https://goreportcard.com/report/github.com/minight/machinery)
[![GolangCI](https://golangci.com/badges/github.com/minight/machinery.svg)](https://golangci.com)
[![OpenTracing Badge](https://img.shields.io/badge/OpenTracing-enabled-blue.svg)](http://opentracing.io)

[![Sourcegraph for RichardKnop/machinery](https://sourcegraph.com/github.com/minight/machinery/-/badge.svg)](https://sourcegraph.com/github.com/minight/machinery?badge)
...
```sh
go get github.com/minight/machinery/v1
```
...
> Keep in mind AMQP is not recommended as a result backend. See [Keeping Results](https://github.com/minight/machinery#keeping-results)
...
Then just set the logger in your setup code by calling `Set` function exported by `github.com/minight/machinery/v1/log` package:
...
import (
  ...
  "github.com/minight/machinery/v1"
)
